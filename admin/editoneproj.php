...
if(isset($_POST['editprjs'])){
  ...
  //$controller = new ctrl_editoneproj();
  $controller->editProj($name, $photo, $id, $projID, $text);

}

$stm = $controller->getOneProj($id, $projID);
$stm->bind_result($name, $text, $photo);
$stm->fetch();
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <form class="was-validated addprojs" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <img src="../images/proj_photos/<?php echo $photo; ?>" class="rounded" style="width: 100%; padding: 10px;">
              <br><br>
